...
public class ItemGroupAnalyzerOptmizedTest extends TestCase {
	public void testFindCommonParent() {
		...
		list.add(new int[]{5,1,3});
		list.add(new int[]{5});
		assertEquals(5, ItemGroupAnalyzerOptimized.findCommonParent2(list, 10));
		list = new ArrayList<int[]>();
		list.add(new int[]{5,1,3});
		list.add(new int[]{5,1,2});
		list.add(new int[]{4});
		assertEquals(-1, ItemGroupAnalyzerOptimized.findCommonParent2(list, 10));
		list = new ArrayList<int[]>();
		list.add(new int[]{5,1,3,6});
		list.add(new int[]{5,1,3,7});
		list.add(new int[]{5,4});
		assertEquals(3, ItemGroupAnalyzerOptimized.findCommonParent2(list, 40));
		list = new ArrayList<int[]>();
		list.add(new int[]{6,5,1,3});
		list.add(new int[]{});
		list.add(new int[]{6,5,4});
		list.add(new int[]{6,5,2});
		assertEquals(5, ItemGroupAnalyzerOptimized.findCommonParent2(list, 27));
		list = new ArrayList<int[]>();
